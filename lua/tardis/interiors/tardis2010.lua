...
T.Interior = {
	...
	ExitBox = {
		Min = Vector(-912.799, -1443.308, -297.528),
		Max = Vector(1154.64, 1210.972, 275.318)
	},
	Size = {
		Min = Vector(-402.682, -462.459, -206.813),
		Max = Vector(550.608, 496.177, 274.261)
	},
	...
	Parts = {
		...
		-- hugoextension stuff
		chronoplasmicshell			= {matrixScale = Vector(30,30,30),},
		tardisfireexting			= {pos = Vector(170,-250,-95), 				ang = Angle(0, -30, 0), },
		thirdperson_utility 		= {pos = Vector(-20.21,-34.41,43.21), 		ang = Angle(0, 150, 60), }, -- placed on atom accelerator
	...
	TipSettings = {
		...
		view_range_max = 70,
		view_range_min = 60,
		TextOverrides = {   -- these dont appear to work in the modern version of the addon
	...
	PartTips = {
		...
		tardis2010_toggles 				= {pos = Vector(-25.11,32.14,41.43),		down = false,	right = false,	text = "Exterior Appearance Reconfiguration",	},
		thirdperson_utility 			= {pos = Vector(-20.21,-34.41,43.21),		down = false,	right = true,	text = "Atom Accelerator",						},
		tardis2010_qfm2 				= {pos = Vector(0.02,45.79,43.43),			down = false,	right = true,	text = "Window Opacity",						},
		tardis2010_plotter 				= {pos = Vector(7.8, 56.9, 35),				down = false,	right = false,	text = "Zig-Zag Plotter",						},
		tardis2010_stabilisers 			= {pos = Vector(-32.43,34.33,41.15),		down = false,	right = false,	text = "Turbulence Nullifier",					},
		tardis2010_directionalpointer 	= {pos = Vector(-13.239, -22.873, 61.436),	down = false,	right = false,	text = "Voidway Telescope",						},
		tardis2010_valves 				= {pos = Vector(-5.478, -18.736, 63.498),	down = false,	right = false,	text = "Engine Thermals Bypass",				},
		tardis2010_bluevalves 			= {pos = Vector(14.6,-42.53,44.24),			down = false,	right = false,	text = "Samsara Boil-off Valves",				},
		tardis2010_pump2 				= {pos = Vector(-30.95,26.06,49.24),		down = false,	right = false,	text = "Physical Lock Pressurizer",				},
		tardis2010_rotaryswitch 		= {pos = Vector(-43.9, 32.5, 33.2),			down = false,	right = false,	text = "Hazard Response Dial",					},
	...
	Controls = {
		...
		-- hugoextension stuff/changes
		tardis2010_button2					= "vortexswap",
		tardis2010_timespaceforwardback 	= "timeswap",
		tardis2010_qfm2 					= "windowopacity",
		tardis2010_controlbox1b          	= "shields",
		tardis2010_wibblylever				= "maptravel",
		tardis2010_bluevalves           	= "returntobar",
		tardis2010_directionalpointer       = "randomjazzmap",
		tardis2010_speedpad       			= "manualmapdestination",
		tardis2010_button1           		= "hadssensitivity",
		tardis2010_valves         			= "mathop",
		tardis2010_pump1          			= "mathop_shortcut",
		tardis2010_stabilisers				= "vortexdrift",
		tardis2010_plotter					= "multiloopstabiliser",
...
T.Exterior = {
	...
	Parts = {
		vortex = {
			...
			ang = Angle(0,0,0),
			scale = 5,
			pastmodel = "models/doctorwho1200/copper/2010timevortex_past.mdl",
		},
		door = {
		...
		stephelper = {pos = Vector(18,0,0.2), ang = Angle(0, 0, 0), },  -- forward, side, up
		stephelper2 = {pos = Vector(14,0,3.45), ang = Angle(0, 0, 0), },
	},
...
T.CustomHooks = {
	power_textures = {
		...
		func = function(ext, int)
			...
			if not power and lowpower then
